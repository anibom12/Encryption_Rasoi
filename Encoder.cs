...
public class Decoder : Icoder
{
    ...
    public string Encode(string sender, string receiver, string text)
    {
        throw new NotImplementedException("Use specific encoding methods instead.");
    }

    public string Decode(string encodedSender, string encodedReceiver, string encodedText)
    {
        return DecodeMethod1(encodedSender, encodedReceiver, encodedText); // یا استفاده از DecodeMethod2
    }
